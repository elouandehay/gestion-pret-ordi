...
\fancyhead[L]{\includegraphics[height=1.5cm]{../../INSA_logo.png}}

% Pied de page (logo graphique rouge en bas à droite)
\fancyfoot[R]{\includegraphics[height=1.5cm]{../../INSA_graphic.png}}
...
Madame / Monsieur \textbf{ Morel Elise } \\
...
\begin{itemize}
    ...
    \item un virement bancaire d'un montant de 110€ auprès de l’agence comptable de l’INSA Rennes, à l’exception des étudiants boursiers.
\end{itemize}
...
\begin{itemize}
  \item Désignation matériel : DELL XPS 15
  \item Numéro d’inventaire : 2025-DE1247
  \item Numéro de série : Dell676253379
\end{itemize}
...
Fait en un exemplaire original, à Rennes, le : 30/04/2026.
...
Observations lors de l’emprunt : Etat propre !
